...
const AddCategoryForm = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
    //     fetch("https://api.jetali.uk/api/v1/productcategory", requestOptions)
            ...
            <Grid container>
                <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                    <div className="addcategory__form--inputs">
                        <div>
                            <label htmlFor="name" name="name">Category Name:</label>
                            <input type="text" value={categoryName} onChange={e => setCategoryName(e.target.value)} required  />
                        </div>
                        <div>
                            <label htmlFor="image" name="image">Cateogry Icon:</label>
                            <input type="file" id="myFile" name="filename" multiple onChange={handleIcon} required />
                        </div>
                        <div>
                            <label htmlFor="type" name="type">Cateogry Image:</label>
                            <input type="file" id="myFile" name="filename" multiple onChange={handleImage} required />
                        </div>
                    </div>
                </Grid>
                {/* <Grid item xs={6} sm={6} md={6} lg={6} xl={6}>
                  ...
                  <div className="formsubmit__button">
                        <button ><PrimaryButton text="Add Category" width="50px" /></button>
                    </div>
            </Grid>
        </form>
    </div>
